    ...
    <nav className={className}>
      ...
      <ul className='navigation__user-contacts'>
        <li className='navigation__user-contact'>
          <a href='mailto:vitaliy.stanyshevskyy@gmail.com' aria-label={emailLabel}>
            <MdMail className='navigation__user-email-icon'/>
          </a>
        </li>
        <li className='navigation__user-contact'>
          <a href='https://docs.google.com/document/d/13xPDDYugeCrWdRtD6Owd0SvQQrMr_KoP9ScY9I4OvjM/edit?usp=sharing' aria-label={cvLabel}>
            <MdBusinessCenter />
          </a>
        </li>
        <li className='navigation__user-contact'>
          <a href='https://www.linkedin.com/in/stanyshevskyy/' aria-label={linkedinLabel}>
            <FaLinkedinIn />
          </a>
        </li>
      </ul>
